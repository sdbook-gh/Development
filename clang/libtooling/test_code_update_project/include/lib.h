...
class NMAnotherClass {
  public:
    template<typename T>
    std::shared_ptr<T> get_instance(const T& in) {
...
public:
  ...
  std::shared_ptr<open::nmutils::nmlog::NMAsyncLog> adjust_NM_log(std::shared_ptr<open::nmutils::nmlog::NMAsyncLog> log, std::shared_ptr<NMAnotherClass> another);
