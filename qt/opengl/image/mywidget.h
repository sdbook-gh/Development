...
public:
    ImgShow(QWidget *parent = nullptr) : QOpenGLWidget(parent) {}
...
protected:
    ...
    void paintGL() override {
        ...
        // 绘制纹理为全屏四边形
        glBegin(GL_QUADS);
        glTexCoord2f(0, 1-0); glVertex2f(-1, -1);
        glTexCoord2f(1, 1-0); glVertex2f(1, -1);
        glTexCoord2f(1, 1-1); glVertex2f(1, 1);
        glTexCoord2f(0, 1-1); glVertex2f(-1, 1);
        glEnd();
