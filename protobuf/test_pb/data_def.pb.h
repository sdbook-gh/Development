...
#ifndef GOOGLE_PROTOBUF_INCLUDED_data_5fdef_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_data_5fdef_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_data_5fdef_2eproto
...
struct TableStruct_data_5fdef_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_data_5fdef_2eproto;
namespace mygame {
class Monster;
...
class Vec3 final :
 ...
 private:
  ...
  friend struct ::TableStruct_data_5fdef_2eproto;
};
// -------------------------------------------------------------------
...
void Monster::set_inventory(ArgT0&& arg0, ArgT... args) {
 ...
 inventory_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Monster::set_allocated_inventory(std::string* inventory) {
  ...
  inventory_.SetAllocated(inventory, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (inventory_.IsDefault()) {
...
inline ::mygame::Monster_Color Monster::_internal_color() const {
  return static_cast< ::mygame::Monster_Color >(color_);
}
...
inline bool Monster::_internal_has_equipped() const {
  return this != internal_default_instance() && equipped_ != nullptr;
}
...
inline const ::mygame::Weapon& Monster::_internal_equipped() const {
  const ::mygame::Weapon* p = equipped_;
...
inline void Monster::unsafe_arena_set_allocated_equipped(
    ::mygame::Weapon* equipped) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(equipped_);
  }
  equipped_ = equipped;
  if (equipped) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_data_5fdef_2eproto
